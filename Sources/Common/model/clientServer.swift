...
// Tracking issue for making it public: https://github.com/dme86/ddwm/issues/1513
...
public struct ClientRequest: Codable, Sendable, ConvenienceCopyable, Equatable {
    ...
    public var windowId: UInt32??  // Please forward DDWM_WINDOW_ID env variable here
    public var workspace: String?? // Please forward DDWM_WORKSPACE env variable here
