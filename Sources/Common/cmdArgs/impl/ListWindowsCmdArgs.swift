...
public enum DdwmObjKind: CaseIterable, Sendable {
    case window, workspace, app, monitor
}

public func getAvailableInterVars(for kind: DdwmObjKind) -> [String] {
    _getAvailableInterVars(for: kind) + PlainInterVar.allCases.map(\.rawValue)
}

private func _getAvailableInterVars(for kind: DdwmObjKind) -> [String] {
    switch kind {
