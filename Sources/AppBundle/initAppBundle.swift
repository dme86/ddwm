...
private let serverHelp = """
    USAGE: \(CommandLine.arguments.first ?? "ddwm.app/Contents/MacOS/ddwm") [<options>]

    OPTIONS:
      -h, --help              Print help
      -v, --version           Print ddwm.app version
      --config-path <path>    Config path. It will take priority over ~/.ddwm.toml
                              and ${XDG_CONFIG_HOME}/ddwm/ddwm.toml
