...
extension AxUiElementMock {
    ...
    func isDialogHeuristic(
        ...
        // - flameshot? https://github.com/dme86/ddwm/issues/112
        // - Drata Agent https://github.com/dme86/ddwm/issues/134
    ...
    func isWindowHeuristic(
        ...
        // https://github.com/dme86/ddwm/issues/103
        ...
        // - Share window purple "pill" indicator https://github.com/dme86/ddwm/issues/1101. Title is not empty
    ...
    private func isWindowHeuristicOld(axApp: AxUiElementMock, _ id: KnownBundleId?) -> Bool { // 0.18.3 hotfix
        ...
        if get(Ax.closeButtonAttr) == nil &&
            ...
            // Share window purple "pill" indicator has "Window" title https://github.com/dme86/ddwm/issues/1101
