...
struct WindowDetectedCallbackMatcher: ConvenienceCopyable, Equatable {
    ...
    var debugJson: Json {
        ...
        if let duringddwmStartup {
            resultParts.append("duringddwmStartup=\(duringddwmStartup)")
        }
...
private let matcherParsers: [String: any ParserProtocol<WindowDetectedCallbackMatcher>] = [
    ...
    "during-ddwm-startup": Parser(\.duringddwmStartup, upcast(parseBool)),
]
