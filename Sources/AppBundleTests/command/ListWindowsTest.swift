...
final class ListWindowsTest: XCTestCase {
    ...
    func testInterpolationVariablesConsistency() {
        for kind in DdwmObjKind.allCases {
            switch kind {
                case .window:
    ...
    func testFormat() {
        Workspace.get(byName: name).rootTilingContainer.apply {
            let windows = [
                DdwmObj.window(window: TestWindow.new(id: 2, parent: $0), title: "non-empty"),
                DdwmObj.window(window: TestWindow.new(id: 1, parent: $0), title: ""),
            ]
        ...
        Workspace.get(byName: name).rootTilingContainer.apply {
            let windows = [
                DdwmObj.window(window: TestWindow.new(id: 2, parent: $0), title: "non-empty"),
                DdwmObj.window(window: TestWindow.new(id: 10, parent: $0), title: ""),
            ]
        ...
        Workspace.get(byName: name).rootTilingContainer.apply {
            let windows = [
                DdwmObj.window(window: TestWindow.new(id: 2, parent: $0), title: "title1"),
                DdwmObj.window(window: TestWindow.new(id: 10, parent: $0), title: "title2"),
            ]
