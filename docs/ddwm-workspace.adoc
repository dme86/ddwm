...
[verse]
// tag::synopsis[]
ddwm workspace [-h|--help] [--auto-back-and-forth] [--fail-if-noop] <workspace-name>
ddwm workspace [-h|--help] [--wrap-around] [--stdin|--no-stdin] (next|prev)
...
`ddwm list-workspaces --monitor focused --empty no | ddwm workspace next`
