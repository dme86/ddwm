...
[verse]
// tag::synopsis[]
ddwm fullscreen [-h|--help]     [--window-id <window-id>] [--no-outer-gaps]
ddwm fullscreen [-h|--help] on  [--window-id <window-id>] [--no-outer-gaps] [--fail-if-noop]
ddwm fullscreen [-h|--help] off [--window-id <window-id>] [--fail-if-noop]
