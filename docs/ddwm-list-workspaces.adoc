= ddwm-list-workspaces(1)
include::util/man-attributes.adoc[]
:manname: ddwm-list-workspaces
// tag::purpose[]
...
[verse]
// tag::synopsis[]
ddwm list-workspaces [-h|--help] --monitor <monitor>... [--visible [no]] [--empty [no]] [--format <output-format>] [--count] [--json]
ddwm list-workspaces [-h|--help] --all [--format <output-format>] [--count] [--json]
ddwm list-workspaces [-h|--help] --focused [--format <output-format>] [--count] [--json]
...
%{workspace-root-container-layout}:: String. The layout (`h_tiles`, `v_tiles`, `monocle`) of the workspace's root container
