...
:manname: ddwm-config
// tag::purpose[]
:manpurpose: Query ddwm config options
// end::purpose[]
...
[verse]
// tag::synopsis[]
ddwm config [-h|--help] --get <name> [--json] [--keys]
ddwm config [-h|--help] --major-keys
ddwm config [-h|--help] --all-keys
ddwm config [-h|--help] --config-path
...
+
----
$ ddwm config --get mode.main.binding --json
{
  "alt-w" : "workspace W",
  "alt-y" : "workspace Y",
  "alt-n" : "workspace N",
