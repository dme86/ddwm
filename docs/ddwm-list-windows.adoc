...
[verse]
// tag::synopsis[]
ddwm list-windows [-h|--help] (--workspace <workspace>...|--monitor <monitor>...)
                       [--monitor <monitor>...] [--workspace <workspace>...]
                       [--pid <pid>] [--app-bundle-id <app-bundle-id>] [--format <output-format>]
                       [--count] [--json]
ddwm list-windows [-h|--help] --all [--format <output-format>] [--count] [--json]
ddwm list-windows [-h|--help] --focused [--format <output-format>] [--count] [--json]
...
%{window-is-fullscreen}:: Boolean. Is window in fullscreen by `ddwm fullscreen` command
%{window-layout}:: String. Alias for `%{window-parent-container-layout}`
%{window-parent-container-layout}:: String. The layout (`h_tiles`, `v_tiles`, `monocle`, `floating`) of the window's parent container.
...
%{workspace-root-container-layout}:: String. The layout (`h_tiles`, `v_tiles`, `monocle`) of the workspace the window belongs to.
