= ddwm-move-node-to-monitor(1)
include::util/man-attributes.adoc[]
:manname: ddwm-move-node-to-monitor
// tag::purpose[]
...
[verse]
// tag::synopsis[]
ddwm move-node-to-monitor [-h|--help] [--window-id <window-id>] [--focus-follows-window]
...
This flag is a shortcut for manually running `ddwm-workspace`/`ddwm-focus` after `move-node-to-monitor` successful execution.
