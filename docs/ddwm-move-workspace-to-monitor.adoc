= ddwm-move-workspace-to-monitor(1)
include::util/man-attributes.adoc[]
:manname: ddwm-move-workspace-to-monitor
// tag::purpose[]
...
[verse]
// tag::synopsis[]
ddwm move-workspace-to-monitor [-h|--help] [--workspace <workspace>] [--wrap-around] (left|down|up|right)
ddwm move-workspace-to-monitor [-h|--help] [--workspace <workspace>] [--wrap-around] (next|prev)
ddwm move-workspace-to-monitor [-h|--help] [--workspace <workspace>] <monitor-pattern>...
