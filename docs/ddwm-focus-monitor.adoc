= ddwm-focus-monitor(1)
include::util/man-attributes.adoc[]
:manname: ddwm-focus-monitor
// tag::purpose[]
...
[verse]
// tag::synopsis[]
ddwm focus-monitor [-h|--help] [--wrap-around] (left|down|up|right)
ddwm focus-monitor [-h|--help] [--wrap-around] (next|prev)
ddwm focus-monitor [-h|--help] <monitor-pattern>...
