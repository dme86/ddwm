...
[verse]
// tag::synopsis[]
ddwm focus [-h|--help] [--ignore-floating] [--wrap-around]
                [--boundaries <boundary>] [--boundaries-action <action>]
                (left|down|up|right)
ddwm focus [-h|--help] [--ignore-floating] [--wrap-around]
                [--boundaries <boundary>] [--boundaries-action <action>]
                (dfs-next|dfs-prev)
ddwm focus [-h|--help] --window-id <window-id>
ddwm focus [-h|--help] --dfs-index <dfs-index>
...
https://github.com/dme86/ddwm/issues/5
