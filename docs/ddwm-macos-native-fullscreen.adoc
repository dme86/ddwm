= ddwm-macos-native-fullscreen(1)
include::util/man-attributes.adoc[]
:manname: ddwm-macos-native-fullscreen
// tag::purpose[]
...
[verse]
// tag::synopsis[]
ddwm macos-native-fullscreen [-h|--help] [--window-id <window-id>]
ddwm macos-native-fullscreen [-h|--help] [--window-id <window-id>] [--fail-if-noop] on
ddwm macos-native-fullscreen [-h|--help] [--window-id <window-id>] [--fail-if-noop] off
