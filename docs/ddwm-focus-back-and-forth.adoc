= ddwm-focus-back-and-forth(1)
include::util/man-attributes.adoc[]
// tag::purpose[]
:manpurpose: Switch between the current and previously focused elements back and forth
// end::purpose[]
:manname: ddwm-focus-back-and-forth

// =========================================================== Synopsis
== Synopsis
[verse]
// tag::synopsis[]
ddwm focus-back-and-forth [-h|--help]
...
ddwm stores only one previously focused window in history,
...
----
ddwm focus-back-and-forth || ddwm workspace-back-and-forth
----
