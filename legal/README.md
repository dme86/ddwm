...
The ddwm itself is licensed under MIT. See [LICENSE](./LICENSE.txt) for the full license text.

## Bundled dependencies and materials

ddwm bundles the following dependencies and uses the following materials:
...
ANTLR is used to parse ddwm built-in shell like language.
